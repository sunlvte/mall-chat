...
export default {
  ...
  methods: {
    ...mapMutations('message/msgCombo', ['messageHid']),
    cancelReload () {
  ...
  computed: {
    ...mapState({
      state: () => store.state.message.msgCombo,
      title: () => store.state.message.msgCombo.title,
      modalShow: () => store.state.message.msgCombo.modalShow
    })
  }
